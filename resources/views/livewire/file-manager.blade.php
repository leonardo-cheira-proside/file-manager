    ...
    @unless ($this->inTrash)
        <div class="fixed bottom-10 right-10 flex flex-col items-center gap-3 z-40" @click.outside="fabOpen = false">
            <div x-show="fabOpen" x-transition class="flex flex-col items-center gap-3">
                <label
                    class="flex items-center justify-center w-12 h-12 bg-white text-proximo-700 rounded-full shadow-xl border border-gray-200 cursor-pointer hover:bg-gray-100"
                    title="@lang('file-manager::file-manager.upload')">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                ...
                <button type="button"
                    ...
                    class="flex items-center justify-center w-12 h-12 bg-white text-proximo-700 rounded-full shadow-xl border border-gray-200 hover:bg-gray-100"
                    title="@lang('file-manager::file-manager.new_folder')">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
